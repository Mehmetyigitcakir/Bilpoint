...
public class UserProfilePanel extends JPanel {
    ...
    public UserProfilePanel(MainFrame parent, User user) {
        this.parent = parent;
    ...
    private JPanel createContentPanel() {
        ...
        cardsPanel.add(createStatsCard("👥 Social Network", ""+ currentUser.getFriends().size() + " Friends", "- Mutual Friends", "Efe Ulu, Arda Ulu..."));
        ...
        currentPhoto.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(UserProfilePanel.this, 
